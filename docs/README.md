...
Welcome to the Sequence FX trading system documentation. This directory contains comprehensive guides, API references, and implementation details for the reinforcement learning-based forex trading platform.
...
### 🚀 Getting Started
- **[Architecture & API Reference](ARCHITECTURE_API_REFERENCE.md)** - System overview, module reference, training workflow
...
- **[Phase 3 Implementation Summary](implementation/PHASE_3_IMPLEMENTATION_SUMMARY.md)** - Transaction costs, position sizing, risk management
...
- **[RL Implementation Comparison](implementation/RL_IMPLEMENTATION_COMPARISON.md)** - "Fake RL" vs "Real RL" migration guide
